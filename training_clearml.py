...
def train_rf_detr(model_size='base',epochs=20,dataset_name="/mnt/fish-detection-coco-dataset/benthic_f_small/rf_data",output_uri="/mnt/fish-detection-coco-dataset/benthic_f_small/models/rf_detr10"):
    ...
    dataset = clearml.Dataset.get(dataset_name=dataset_name)
...
if __name__ == "__main__":
    ...
    argparse.add_argument('--epochs',type=int,help="Number of training epochs",default=20)
    ...
    train_rf_detr(model_size=args.model_size,epochs=args.epochs,dataset_name=args.dataset_dir,output_dir=args.output_dir)    